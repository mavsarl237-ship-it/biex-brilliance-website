...
const upcomingOffices = [
  {
    city: "Brazzaville",
    country: (t: (fr: string, en: string) => string) => t("Congo", "Congo"),
    statusFr: "Bientôt",
    statusEn: "Soon",
    mapEmbed: "https://maps.google.com/maps?width=100%25&height=600&hl=fr&q=Brazzaville,%20Republic%20of%20the%20Congo&t=&z=12&ie=UTF8&iwloc=B&output=embed"
  },
  {
    city: "Libreville",
    country: (t: (fr: string, en: string) => string) => t("Gabon", "Gabon"),
    statusFr: "Bientôt",
    statusEn: "Soon",
    mapEmbed: "https://maps.google.com/maps?width=100%25&height=600&hl=fr&q=Libreville,+Gabon&t=&z=12&ie=UTF8&iwloc=B&output=embed"
  },
  {
    city: "Ouagadougou",
    country: (t: (fr: string, en: string) => string) => t("Burkina Faso", "Burkina Faso"),
    statusFr: "Bientôt",
    statusEn: "Soon",
    mapEmbed: "https://maps.google.com/maps?width=100%25&height=600&hl=fr&q=Ouagadougou,+Burkina+Faso&t=&z=12&ie=UTF8&iwloc=B&output=embed"
  },
  {
    city: "Niamey",
    country: (t: (fr: string, en: string) => string) => t("Niger", "Niger"),
    statusFr: "Bientôt",
    statusEn: "Soon",
  ...
  },
  {
    ...
    statusFr: "Bientôt",
    statusEn: "Soon",
    mapEmbed: "https://maps.google.com/maps?width=100%25&height=600&hl=fr&q=Lome,+Togo&t=&z=12&ie=UTF8&iwloc=B&output=embed"
  }
];
          ...
          {openOffices.map((office, i) => (
            ...
            >
              ...
              <p className="font-subheading font-semibold text-sm mb-3" style={{ color: "hsl(214 65% 52%)" }}>
                {typeof office.country === "function" ? office.country(t) : office.country}
              </p>
              <p className="text-sm font-subheading font-medium mb-2" style={{ color: "hsl(220 45% 30%)" }}>
                {t(office.nameFr, office.nameEn)}
              </p>
              ...
              >
                <div className="flex flex-col items-center text-center justify-between mb-4">
                  <span className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider mb-3" style={{ background: "rgba(220,53,69,0.08)", color: "hsl(358 73% 52%)" }}>
                    {t(office.statusFr, office.statusEn)}
                  </span>
                  <div>
